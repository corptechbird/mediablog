...
<!-- Contents -->             
    <div id="contents">
        <div class="post">   
        <div class="newentry"><?php the_archive_title( $before, $after ); ?></div>     
                                ...
                                <div class="l-card">
                                    ...
                                    <div class="text-content">
                                        ...
                                        <div class="content-meta">
                                            <span class="date"><span class="far fa-clock" aria-hidden="true"></span> <?php the_time('Y.m.d') ?> <?php the_time(); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </a>
