            ...
            <div class="single">
                ...
                <?php if ( have_posts() ) :    // もし投稿があるなら ?>
                    <?php while ( have_posts() ) : the_post();    // 繰り返し処理（ループ）開始 ?>
                        ...
                        <span class="time"><i class="glyphicon glyphicon-time" aria-hidden="true"></i> <?php the_time('Y.n.j H:m'); ?></span>
                        <figure class="frame"><?php the_post_thumbnail(); ?></figure>
                    <?php the_content(); ?>
                    
                    <div class="afterpost">
                    <div><i class="glyphicon glyphicon-book" aria-hidden="true"></i> 他の人はこちらの記事も読んでいます</div>
                        <?php
                                ...
                                <div class="l-card">
                                    ...
                                    <div class="text-content">
                                        ...
                                        <div class="content-meta">
                                            <span class="date">
                                            <i class="glyphicon glyphicon-time" aria-hidden="true"></i> <?php the_time('Y.n.j H:m'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </a>
