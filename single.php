<?php get_header(); ?>        
    <div id="contents">
        ...
        <?php
            ...
            $cat = get_the_category();
            $cat = $cat[0];?>
            <div style="text-align:center;"><a href="<?php echo esc_url( home_url( '/' ) ); ?>/category/<?php echo $cat->slug; ?>" title="<?php echo $cat->name; ?>"><i class="fas fa-newspaper"></i> All Articles of Music Trend in <?php echo $cat->name; ?></div>
            <?php the_content(); ?>
            <?php
                $prev_post = get_previous_post();
                $next_post = get_next_post();
