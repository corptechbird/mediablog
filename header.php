...
<head>
    ...
    <title>
        ...
        <?php elseif(is_category()): //カテゴリ一覧ページ ?>
        <?php single_cat_title() ?> ｜ <?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>
        
        <?php elseif(is_month()): //月別ページ ?>
        <?php the_time("Y年m月") ?>の記事一覧 ｜ <?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>
        
        <?php elseif(is_year()): //年別ページ ?>
        <?php the_time("Y年") ?> ｜ <?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>
        
        <?php elseif(is_search())://検索結果ページ ?>
        検索結果 ｜ <?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>
